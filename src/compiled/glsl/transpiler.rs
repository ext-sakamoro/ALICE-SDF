    ...
    fn transpile_node_inner(
        ...
        match node {
            ...
            SdfNode::IcosahedralSymmetry { child } => {
                ...
                writeln!(code, "    vec3 {} = abs({});", p_ico, point_var).unwrap();
                ...
                for _ in 0..8 {
                    ...
                    writeln!(
                        code,
                        "    if ({}.x + {} * {}.y < 0.0) {{ {} = vec3(-{}.x, -{}.y * {}, {}.z); }}",
                        p_ico, phi_s, p_ico, p_ico, p_ico, p_ico, phi_s, p_ico
                    )
                    .unwrap();
                    writeln!(
                        code,
                        "    if ({}.y + {} * {}.z < 0.0) {{ {} = vec3({}.x, -{}.y, -{}.z * {}); }}",
                        p_ico, phi_s, p_ico, p_ico, p_ico, p_ico, p_ico, phi_s
                    )
                    .unwrap();
                    writeln!(
                        code,
                        "    if ({}.z + {} * {}.x < 0.0) {{ {} = vec3(-{}.x * {}, {}.y, -{}.z); }}",
                        p_ico, phi_s, p_ico, p_ico, p_ico, phi_s, p_ico, p_ico
                    )
                    .unwrap();
            ...
            SdfNode::SurfaceRoughness {
                ...
                writeln!(code, "        vec3 q = {} * {};", point_var, freq_s).unwrap();
