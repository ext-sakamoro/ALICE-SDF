# ALICE-SDF Detailed Usage

This document holds detailed usage examples and technical deep-dives that were
split out of the main `README.md` for readability. See the
[main README](../README.md) for project overview, quick-start, and binding
catalog. Releases prior to v1.5.0 are in
