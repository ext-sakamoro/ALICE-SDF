...
namespace AliceSDF.Editor
{
    public class AliceSDF_Baker : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                ...
                "v0.3: Instruction Fusion + Division Exorcism + Scalar Expansion",
                MessageType.Info
            );
    ...
    // =========================================================================
    // Shader Generator v0.3 (Deep Fried: Instruction Fusion + Division Exorcism)
    // =========================================================================
...
{mapBody}
    ...
    // =========================================================================
    // Udon Generator v0.3 (Deep Fried: Scalar Expansion + Inline CSG)
    // =========================================================================
    ...
    public static class UdonGenerator
    {
        ...
        public static string GenerateFullScript(SdfNodeData node, string name)
        {
            ...
            // Standalone class: no inheritance from AliceSDF_Collider.
            // UdonSharp does not support virtual method dispatch through inheritance,
            // so we inline PostLateUpdate + EstimateGradient + collision fields directly.
            return $@"// Auto-generated by ALICE-SDF Baker v0.3 (Standalone)
// Name: {name}
...
{{
    ...
    public class {name}_Collider : UdonSharpBehaviour
#else
    public class {name}_Collider : MonoBehaviour
#endif
    {{
        [Header(""Collision Settings"")]
        [Tooltip(""Distance margin around the SDF surface."")]
        ...
        [Tooltip(""Epsilon for gradient estimation."")]
        public float gradientEps = 0.02f;

        [Tooltip(""Maximum push distance per frame."")]
        public float maxPushDistance = 2.0f;

        [Header(""Performance"")]
        [Tooltip(""Only check collision every N fixed updates."")]
        [Range(1, 4)]
        ...
        /// <summary>Generated SDF evaluation (v0.3 Standalone).</summary>
...
{evalBody}
        ...
        {{
            ...
            {{
                ...
                float penetration = Mathf.Min(collisionMargin - dist, maxPushDistance);
                Vector3 correction = normal * penetration * pushStrength;
                _localPlayer.TeleportTo(playerPos + correction, _localPlayer.GetRotation());

                if (debugMode)
                    Debug.Log($""[AliceSDF] Push: d={{dist:F3}}, corr={{correction.magnitude:F3}}"");
            }}
        }}
#endif
